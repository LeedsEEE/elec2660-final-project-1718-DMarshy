...
- (instancetype)init
{
    ...
    if (self) {
        ...
        mediterraneanChicken.instructions = @"-1-\n Preheat the oven to 180 degrees/ fan oven 200 degrees/gas mark 6.\n-2-\nPut all the ingreients, except the stock and paprika, in a casserole dish. Distribute the oil evenly and arrange the pieces so that the skins of the chicken will brown. Add the stock and sprinke the casserole with paprika\n-3-\nPut in the oven for 45-50 minutes until the chicken is browned and cooked through. Test one piece to make sure.";
        ...
        chickpeaChorizocouscous.name = @"Chickpea and Chorizo Couscous";
        ...
        limeTunaCousCous.instructions = @"-1- \nPlace the couscous and lime zest in a bowl and pour over the boiling water and crumbled vegetable stock cube. Put a plate over the top to keep the heat in and leave to stand for 5 minutes. \n-2-\n Mix together the lime juice, sugar, salt and pepper and olive oil to make a dressing. \n-3-\nOnce the couscous is cooked, add the drained tuna, tomatoes, cucumber, sweetcorn and the dressing to the couscouus. Stir and serve.";
        ...
        Recipe *tunaMushroomSpaghetti = [[Recipe alloc] init];
        tunaMushroomSpaghetti.name = @"Tuna and Mushroom Spaghetti";
        tunaMushroomSpaghetti.ingredients = @" 1 1/2 portions spaghetti\n185g can tuna in oil, drained\n1 teaspoon oil to fry\njuice of a 1/2 lemon\n1 small onion, sliced\n1/2 mug grated parmesan\n5-6 mushrooms, sliced\n1 dessertspoon dried chives\n1/2 mug frozen peas, defrosted\n3 tablespoons Greek yogurt";
        tunaMushroomSpaghetti.instructions = @"-1-\nCook the spaghetti. Drain and return to the pan. \n-2- \nWhile the spaghetti is cooking, heat a little oil in a wok, fry the onion until it begins to softenn. Add the mushrooms and the peas and cook for 1 minute. Season Well.\n-3-\nTake the pan off the heat and add the yogurt, tuna, lemon juice, grated Parmesan and the chives. Stir gently. Add to the drained spaghetti. Stir gently and serve.";
        ...
        Recipe *salmonPasta = [[Recipe alloc] init];
        ...
        salmonPasta.instructions = @"-1-\nCook the tagliatelle. It should only take about 3-4 minutes to cook. Leave to drain\n-2-\nFry the salmon in a little olive oil (if you have a small piece it should only take 2-3 minutes each side). Add the spring onions to the pan towards the end of the cooking time and allow them to brown a little\n-3-\nRemove the pan from the heat and gently break up the salmon. Add the cream and the chives and return to the heat. As soon as the cream begins to bubble, add the pasta and stir everything together. Allow the pasta to heat through. This should take around 1 minute.\n-4-\nSeason well with salt and pepper";
        ...
        Recipe *cauliflowerAndBroccoliCheese = [[Recipe alloc] init];
        ...
        tomatoSauce.name = @"Piquant Tomato Sauce";
        ...
        tomatoSauce.photo = @"TomtoSauce.jpg";//http://uprootkitchen.com/2015/01/26/homemade-tomato-sauce/
       ...
       /* Recipe *deathSauce = [[Recipe alloc] init];
        ...
        self.basics = [NSMutableArray array];//basics
        ...
        pasta.instructions = @"Boil enough water to cover the pasta. Once the water is boiling, add the pasta. Simmer for the appropriate time, drain and add butter or olive oil to prevent the pasta sticking together.";
        ...
        [self.basics addObject:rice];//adding objects to the arrays
